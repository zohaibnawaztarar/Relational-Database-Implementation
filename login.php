...
<head>
	...
	<title>OpenAir Booking | Login</title>
...
<body onload="">
	...
	<div id="id5" class="welcome mt-lg-1 mt-5">
		...
		<?php
				echo '<h1 class="display-4 text-center"> Welcome '.htmlentities($userName, ENT_QUOTES | ENT_IGNORE, "UTF-8")." to Open Air Booking's Login/Out Page </h1> <br>";
