...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <a class="navbar-brand" href="#"><i class="fas fa-paper-plane"></i> OpenAir Booking</a>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="float-lg-right text-center">
                        <h1 class="mt-5">Find your perfect holiday</h1>
                        <hr />
                ...
                <a href="packages.php?where=China" class="custom-card">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            ...
                            <hr />
                            <a href="packages.php?where=China" class="btn btn-success buy-btn">Check Packages</a>
                        </div>
                    </div>
                </a>
            </div>
