...
<head>
    ...
    <title>OpenAir Booking | Customers</title>
        ...
        <div class="container">
            ...
            <div class="row my-5">
                <div class="col-sm-4 buttonlist">
                    ...
                    <button id="add" class="btn crud-btn my-1" onclick="showHideCRUD(this.id)" type="back">Insert Address</button>
                    <button id="update" class="btn crud-btn my-1" onclick="showHideCRUD(this.id)" type="back">Update Address</button>
                    <button id="remove" class="btn crud-btn my-1" onclick="showHideCRUD(this.id)" type="back">Remove Address</button>
                </div>
                <div class="col-sm-8">
                    <div id="view_all_div">
                    ...
                    <div id="add_div">
                        <form action="php/customers/add.php" method="GET">
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">First Name:</label>
                                    <input name="first_name" class="form-control" type="text" placeholder="e.g. Bob" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Last Name:</label>
                                    <input name="last_name" class="form-control" type="text" placeholder="e.g. Smith" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Phone Number:</label>
                                    <input name="phone" class="form-control" type="text" placeholder="e.g. 01234567891" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Email:</label>
                                    <input name="email" class="form-control" type="text" placeholder="e.g. e@mail.com" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Age:</label>
                                    <input name="age" class="form-control" type="text" placeholder="e.g. 30" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Gender:</label>
                                    <input name="gender" class="form-control" type="text" placeholder="e.g. Male" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Nationality:</label>
                                    <input name="nation" class="form-control" type="text" placeholder="e.g. British" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    ...
                                    <?php
                                        ...
                                        while ($record = mysqli_fetch_assoc($resultset)) {
                                            ...
                                            $desc = $record['address_no'] . " " . $record['address_street'] . " " . $record['address_city'];
                                            ?>
                    ...
                    <?php } ?>
                        <div id="update_details">
                            ...
                            <form action="php/customers/update.php" method="GET">
                                <input name="id_update" class="form-control" type="hidden" value="<?php echo $record['customer_id']; ?>" required />
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">First Name:</label>
