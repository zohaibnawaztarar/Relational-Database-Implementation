...
<head>
    ...
    <title>OpenAir Booking | Branches</title>
        ...
        <div class="container">
            ...
            <div class="row my-5">
                <div class="col-sm-4 buttonlist">
                    ...
                    <button id="add" class="btn crud-btn my-1" onclick="showHideCRUD(this.id)" type="back">Insert Branch</button>
                    <button id="update" class="btn crud-btn my-1" onclick="showHideCRUD(this.id)" type="back">Update Branch Info</button>
                    <button id="remove" class="btn crud-btn my-1" onclick="showHideCRUD(this.id)" type="back">Remove Branch Info</button>
                    <?php } ?>
                </div>
                <div class="col-sm-8">
                    <div id="view_all_div">
                    ...
                    <div id="add_div">
                        <form action="" method="GET">
                                <div class="form-group form-inline my-1">
                                    ...
                                    <input class="form-control" type="text" placeholder="e.g. OpenAir Booking Dundee" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                    ...
                    <div id="update_div">
                    <?php
                        if (!isset($_GET['update_branch_id_select'])) { ?>
                        <form action="" method="GET">
                            <div class="form-group">
                                <label for="update_branch_select">Select Branch to Modify:</label>
                                <select class="form-control" id="update_branch_select" name="update_branch_id_select">
                                    <?php
                    ...
                    <?php } ?>
                        <div id="update_details">
                            <?php
                                if (isset($_GET['update_branch_id_select'])) {
                                    $usr = $_GET['update_branch_id_select'];
                                    $sql = "SELECT * FROM branch WHERE branch_id = $usr";
                                    $resultset = mysqli_query($conn, $sql) or die("database error:" . mysqli_error($conn));
                                    while ($record = mysqli_fetch_assoc($resultset)) {
                            ?>
                            <form action="" method="GET">
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Name:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['branch_name']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Phone Number:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['branch_phone_number']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Email:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['branch_email']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Address ID:</label>
                    ...
                    <div id="remove_div">
                    <?php
                        if (!isset($_GET['remove_branch_id_select'])) { ?>
                        <form action="" method="GET">
                            <div class="form-group">
                                <label for="remove_branch_select">Select Branch to Remove:</label>
                                <select class="form-control" id="remove_branch_select" name="remove_branch_id_select">
                                    <?php
                                        $sql = "SELECT * FROM branch";
                                        $resultset = mysqli_query($conn, $sql) or die("database error:" . mysqli_error($conn));
                                        while ($record = mysqli_fetch_assoc($resultset)) {
                    ...
                    <?php } ?>
                        <div id="remove_details">
                            <?php
                                if (isset($_GET['remove_branch_id_select'])) {
                                    $usr = $_GET['remove_branch_id_select'];
                                    $sql = "SELECT * FROM branch WHERE branch_id = $usr";
                                    $resultset = mysqli_query($conn, $sql) or die("database error:" . mysqli_error($conn));
                                    while ($record = mysqli_fetch_assoc($resultset)) {
                            ?>
                            ...
                            <div class="form-group form-inline my-1">
                                    <label class="mx-3">Name:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['branch_name']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Phone Number:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['branch_phone_number']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Email:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['branch_email']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Address ID:</label>
        ...
        <script type="text/javascript">
            ...
            <script type="text/javascript">
                ...
                if (isset($_GET['select'])) {
                    ...
                    } else if (isset($_GET['remove_branch_id_select'])) {
