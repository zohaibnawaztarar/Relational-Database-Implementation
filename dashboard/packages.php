        ...
        <div class="container">
            <div class="row justify-content-around mt-5">
                ...
                <div class="col-sm-8 m-auto text-center">
                    <h1><i class="fas fa-parachute-box"></i> Packages</h1>
                    <?php
            ...
            <div class="row my-5">
                <div class="col-sm-4 buttonlist">
                    ...
                    <button id="add" class="btn crud-btn my-1" onclick="showHideCRUD(this.id)" type="back">Create Package</button>
                    <button id="update" class="btn crud-btn my-1" onclick="showHideCRUD(this.id)" type="back">Update Package</button>
                    <button id="remove" class="btn crud-btn my-1" onclick="showHideCRUD(this.id)" type="back">Remove Package</button>
                </div>
                <div class="col-sm-8">
                    <div id="view_all_div">
                    ...
                    <div id="add_div">
                        <form action="" method="GET">
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Price (£):</label>
                                    <input class="form-control" type="text" placeholder="e.g. 1234.56" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">City:</label>
                                    <input class="form-control" type="text" placeholder="e.g. Dundee" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Country:</label>
                                    <input class="form-control" type="text" placeholder="e.g. United Kingdom" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Internal Cost:</label>
                                    <input class="form-control" type="text" placeholder="e.g. 1234.56" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Description:</label>
                                    <input class="form-control" type="text" placeholder="e.g. Dundee is a fascinating city..." value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Image (URL):</label>
                                    <input class="form-control" type="text" placeholder="e.g. image.jpg" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Payment Plan ID:</label>
                                    <input class="form-control" type="text" placeholder="e.g. 1" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Availability ID:</label>
                                    <input class="form-control" type="text" placeholder="e.g. 1" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Attraction ID:</label>
                                    <input class="form-control" type="text" placeholder="e.g. 1" value="" required />
                                </div>
                    ...
                    <div id="update_div">
                    <?php
                        if (!isset($_GET['update_pkg_id_select'])) { ?>
                        <form action="" method="GET">
                            <div class="form-group">
                                <label for="update_pkg_select">Select Package to Modify:</label>
                                <select class="form-control" id="update_pkg_select" name="update_pkg_id_select">
                                    <?php
                                        ...
                                        while ($record = mysqli_fetch_assoc($resultset)) {
                                            unset($id, $name);
                                            $id = $record['pkg_id'];
                                            $desc = $record['pkg_city'] . " " . $record['pkg_country'];
                                            ?>
                    ...
                    <?php } ?>
                        <div id="update_details">
                            <?php
                                if (isset($_GET['update_pkg_id_select'])) {
                                    $usr = $_GET['update_pkg_id_select'];
                                    $sql = "SELECT * FROM package WHERE pkg_id = $usr";
                                    $resultset = mysqli_query($conn, $sql) or die("database error:" . mysqli_error($conn));
                                    while ($record = mysqli_fetch_assoc($resultset)) {
                            ?>
                            <form action="" method="GET">
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Price (£):</label>
                                    <input class="form-control" type="text" value="<?php echo $record['pkg_price']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">City:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['pkg_city']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Country:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['pkg_country']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Internal Cost:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['pkg_internal_cost']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Description:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['pkg_description']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Image (URL):</label>
                                    <input class="form-control" type="text" value="<?php echo $record['pkg_image']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Payment Plan ID:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['pp_id']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Availability ID:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['availability_avail_id']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Attraction ID:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['attractions_attract_id']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-4">
                    ...
                    <div id="remove_div">
                    <?php
                        if (!isset($_GET['remove_pkg_id_select'])) { ?>
                        <form action="" method="GET">
                            <div class="form-group">
                                <label for="remove_pkg_select">Select Package to Remove:</label>
                                <select class="form-control" id="remove_pkg_select" name="remove_pkg_id_select">
                                    <?php
                                        $sql = "SELECT * FROM package";
                                        $resultset = mysqli_query($conn, $sql) or die("database error:" . mysqli_error($conn));
                                        while ($record = mysqli_fetch_assoc($resultset)) {
                    ...
                    <?php } ?>
                        <div id="remove_details">
                            ...
                            <form action="" method="GET">
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Price (£):</label>
                                    <input class="form-control" type="text" value="<?php echo $record['pkg_price']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">City:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['pkg_city']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Country:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['pkg_country']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Internal Cost:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['pkg_internal_cost']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Description:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['pkg_description']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Image (URL):</label>
                                    <input class="form-control" type="text" value="<?php echo $record['pkg_image']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Payment Plan ID:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['pp_id']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Availability ID:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['availability_avail_id']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Attraction ID:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['attractions_attract_id']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-4">
        ...
        <script type="text/javascript">
            ...
            <script type="text/javascript">
                ...
                if (isset($_GET['select'])) {
                    ...
                    } else if (isset($_GET['remove_pkg_id_select'])) {
