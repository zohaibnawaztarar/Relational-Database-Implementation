...
<head>
    ...
    <title>OpenAir Booking | Marketing</title>
        ...
        <div class="container">
            <div class="row justify-content-around mt-5">
                ...
                <div class="col-sm-8 m-auto text-center">
                    <h1><i class="fas fa-tv"></i> Marketing</h1>
                    <?php
            ...
            <div class="row my-5">
                <div class="col-sm-4 buttonlist">
                    ...
                    <button id="add" class="btn crud-btn my-1" onclick="showHideCRUD(this.id)" type="back">Create Campaign</button>
                    <button id="update" class="btn crud-btn my-1" onclick="showHideCRUD(this.id)" type="back">Update Campaign</button>
                    <button id="remove" class="btn crud-btn my-1" onclick="showHideCRUD(this.id)" type="back">Remove Campaign</button>
                </div>
                <div class="col-sm-8">
                    <div id="view_all_div">
                    ...
                    <div id="add_div">
                        <form action="" method="GET">
                                <div class="form-group form-inline my-1">
                                    ...
                                    <input class="form-control" type="text" placeholder="e.g. TV Advertising Campaign" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Type:</label>
                                    <input class="form-control" type="text" placeholder="e.g. Online Video Advertising" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Budget:</label>
                                    <input class="form-control" type="text" placeholder="e.g. 1234.56" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Start Date:</label>
                                    <input class="form-control" type="date" placeholder="e.g. dd-mm-yyyy" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">End Date:</label>
                                    <input class="form-control" type="date" placeholder="e.g. dd-mm-yyyy" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                    ...
                    <div id="update_div">
                    <?php
                        if (!isset($_GET['update_pr_id_select'])) { ?>
                        <form action="" method="GET">
                            <div class="form-group">
                                <label for="update_pr_select">Select Campaign to Modify:</label>
                                <select class="form-control" id="update_pr_select" name="update_pr_id_select">
                                    <?php
                    ...
                    <?php } ?>
                        <div id="update_details">
                            <?php
                                if (isset($_GET['update_pr_id_select'])) {
                                    $usr = $_GET['update_pr_id_select'];
                                    $sql = "SELECT * FROM marketing WHERE pr_id = $usr";
                                    $resultset = mysqli_query($conn, $sql) or die("database error:" . mysqli_error($conn));
                                    while ($record = mysqli_fetch_assoc($resultset)) {
                            ?>
                            <form action="" method="GET">
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Description:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['pr_description']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Type:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['pr_type']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Budget:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['pr_budget']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Start Date:</label>
                                    <input class="form-control" type="date" value="<?php echo $record['pr_start_date']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">End Date:</label>
                                    <input class="form-control" type="date" value="<?php echo $record['pr_end_date']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Package ID:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['package_pkg_id']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-4">
                    ...
                    <div id="remove_div">
                    <?php
                        if (!isset($_GET['remove_pr_id_select'])) { ?>
                        <form action="" method="GET">
                            <div class="form-group">
                                <label for="remove_pr_select">Select Campaign to Remove:</label>
                                <select class="form-control" id="remove_pr_select" name="remove_pr_id_select">
                                    <?php
                                        $sql = "SELECT * FROM marketing";
                                        $resultset = mysqli_query($conn, $sql) or die("database error:" . mysqli_error($conn));
                                        while ($record = mysqli_fetch_assoc($resultset)) {
                    ...
                    <?php } ?>
                        <div id="remove_details">
                            ...
                            <form action="" method="GET">
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Description:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['pr_description']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Type:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['pr_type']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Budget:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['pr_budget']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Start Date:</label>
                                    <input class="form-control" type="date" value="<?php echo $record['pr_start_date']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">End Date:</label>
                                    <input class="form-control" type="date" value="<?php echo $record['pr_end_date']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Package ID:</label>
        ...
        <script type="text/javascript">
            ...
            <script type="text/javascript">
                ...
                if (isset($_GET['select'])) {
                    ...
                    } else if (isset($_GET['remove_pr_id_select'])) {
