...
<head>
    ...
    <title>OpenAir Booking | Equipment</title>
        ...
        <div class="container">
            <div class="row justify-content-around mt-5">
                ...
                <div class="col-sm-8 m-auto text-center">
                    <h1><i class="fas fa-bicycle"></i> Equipment</h1>
                    <?php
            ...
            <div class="row my-5">
                <div class="col-sm-4 buttonlist">
                    ...
                    <button id="add" class="btn crud-btn my-1" onclick="showHideCRUD(this.id)" type="back">Add Equipment</button>
                    <button id="update" class="btn crud-btn my-1" onclick="showHideCRUD(this.id)" type="back">Update Equipment</button>
                    <button id="remove" class="btn crud-btn my-1" onclick="showHideCRUD(this.id)" type="back">Remove Equipment</button>
                    <?php } ?>
                </div>
                <div class="col-sm-8">
                    <div id="view_all_div">
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Requires Training?</th>
                                        <th scope="col">Branch ID</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php tableEquipmentShow($conn); ?>
                                </tbody>
                            </table>
                        </div>
                    </div>
                    <div id="add_div">
                        <form action="" method="GET">
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Type:</label>
                                    <input class="form-control" type="text" placeholder="e.g. Skis" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Value (£):</label>
                                    <input class="form-control" type="text" placeholder="e.g. 123.45" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Description:</label>
                                    <input class="form-control" type="text" placeholder="e.g. Supplied by SkisLTD" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Insured?:</label>
                                    <input class="form-control" type="text" placeholder="e.g. Y" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Requires Training?:</label>
                                    <input class="form-control" type="text" placeholder="e.g. N" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                    ...
                    <div id="update_div">
                    <?php
                        if (!isset($_GET['update_equipment_id_select'])) { ?>
                        <form action="" method="GET">
                            <div class="form-group">
                                <label for="update_equipment_select">Select Equipment to Modify:</label>
                                <select class="form-control" id="update_equipment_select" name="update_equipment_id_select">
                                    <?php
                    ...
                    <?php } ?>
                        <div id="update_details">
                            <?php
                                if (isset($_GET['update_equipment_id_select'])) {
                                    $usr = $_GET['update_equipment_id_select'];
                                    $sql = "SELECT * FROM equipment WHERE equip_id = $usr";
                                    $resultset = mysqli_query($conn, $sql) or die("database error:" . mysqli_error($conn));
                                    while ($record = mysqli_fetch_assoc($resultset)) {
                            ?>
                            <form action="" method="GET">
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Type:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['equip_type']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Value:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['equip_value']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Description:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['equip_description']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Insured?:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['equip_insured']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Requires Training?:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['equip_required_training']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Branch ID:</label>
                    ...
                    <div id="remove_div">
                    <?php
                        if (!isset($_GET['remove_equipment_id_select'])) { ?>
                        <form action="" method="GET">
                            <div class="form-group">
                                <label for="remove_equipment_select">Select User to Remove:</label>
                                <select class="form-control" id="remove_equipment_select" name="remove_equipment_id_select">
                                    <?php
                                        $sql = "SELECT * FROM equipment";
                                        $resultset = mysqli_query($conn, $sql) or die("database error:" . mysqli_error($conn));
                                        while ($record = mysqli_fetch_assoc($resultset)) {
                    ...
                    <?php } ?>
                        <div id="remove_details">
                            <?php
                                if (isset($_GET['remove_equipment_id_select'])) {
                                    $usr = $_GET['remove_equipment_id_select'];
                                    $sql = "SELECT * FROM equipment WHERE equip_id = $usr";
                                    $resultset = mysqli_query($conn, $sql) or die("database error:" . mysqli_error($conn));
                                    while ($record = mysqli_fetch_assoc($resultset)) {
                            ?>
                            ...
                            <div class="form-group form-inline my-1">
                                    <label class="mx-3">Type:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['equip_type']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Value:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['equip_value']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Description:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['equip_description']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Insured?:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['equip_insured']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Requires Training?:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['equip_required_training']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Branch ID:</label>
        ...
        <script type="text/javascript">
            ...
            <script type="text/javascript">
                ...
                if (isset($_GET['select'])) {
                    ...
                    } else if (isset($_GET['remove_equipment_id_select'])) {
