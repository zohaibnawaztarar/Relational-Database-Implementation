...
<head>
    ...
    <title>OpenAir Booking | Attractions</title>
        ...
        <div class="container">
            <div class="row justify-content-around mt-5">
                ...
                <div class="col-sm-8 m-auto text-center">
                    <h1><i class="fas fa-tree"></i> Attractions</h1>
                    <?php
            ...
            <div class="row my-5">
                <div class="col-sm-4 buttonlist">
                    ...
                    <button id="add" class="btn crud-btn my-1" onclick="showHideCRUD(this.id)" type="back">Add Attraction</button>
                    <button id="update" class="btn crud-btn my-1" onclick="showHideCRUD(this.id)" type="back">Update Attraction Details</button>
                    <button id="remove" class="btn crud-btn my-1" onclick="showHideCRUD(this.id)" type="back">Remove Attraction</button>
                </div>
                <div class="col-sm-8">
                    <div id="view_all_div">
                    ...
                    <div id="add_div">
                        <form action="" method="GET">
                                <div class="form-group form-inline my-1">
                                    ...
                                    <input name="location" class="form-control" type="text" placeholder="e.g. London" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Type:</label>
                                    <input class="form-control" type="text" placeholder="e.g. Tour, Bike Hire" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Image Name:</label>
                                    <input class="form-control" type="text" placeholder="e.g. promo_img.jpg" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                    ...
                    <div id="update_div">
                    <?php
                        if (!isset($_GET['update_attract_id_select'])) { ?>
                        <form action="" method="GET">
                            <div class="form-group">
                                <label for="update_attract_select">Select Attraction to Modify:</label>
                                <select class="form-control" id="update_attract_select" name="update_attract_id_select">
                                    <?php
                                        $sql = "SELECT * FROM attractions";
                                        $resultset = mysqli_query($conn, $sql) or die("database error:" . mysqli_error($conn));
                                        while ($record = mysqli_fetch_assoc($resultset)) {
                                            unset($id, $name);
                                            $id = $record['attract_id'];
                                            $desc = $record['attract_location'];
                                            ?>
                    ...
                    <?php } ?>
                        <div id="update_details">
                            <?php
                                if (isset($_GET['update_attract_id_select'])) {
                                    $usr = $_GET['update_attract_id_select'];
                                    $sql = "SELECT * FROM attractions WHERE attract_id = $usr";
                                    $resultset = mysqli_query($conn, $sql) or die("database error:" . mysqli_error($conn));
                                    while ($record = mysqli_fetch_assoc($resultset)) {
                            ?>
                            <form action="" method="GET">
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Location:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['attract_location']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Type:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['attract_type']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Image Name:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['attract_image']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Address:</label>
                    ...
                    <div id="remove_div">
                    <?php
                        if (!isset($_GET['remove_attract_id_select'])) { ?>
                        <form action="" method="GET">
                            <div class="form-group">
                                <label for="remove_attract_select">Select Attraction to Remove:</label>
                                <select class="form-control" id="remove_attract_select" name="remove_attract_id_select">
                                    <?php
                                        $sql = "SELECT * FROM attractions";
                                        $resultset = mysqli_query($conn, $sql) or die("database error:" . mysqli_error($conn));
                                        while ($record = mysqli_fetch_assoc($resultset)) {
                    ...
                    <?php } ?>
                        <div id="remove_details">
                            <?php
                                if (isset($_GET['remove_attract_id_select'])) {
                                    $usr = $_GET['remove_attract_id_select'];
                                    $sql = "SELECT * FROM attractions WHERE attract_id = $usr";
                                    $resultset = mysqli_query($conn, $sql) or die("database error:" . mysqli_error($conn));
                                    while ($record = mysqli_fetch_assoc($resultset)) {
                            ?>
                            ...
                            <div class="form-group form-inline my-1">
                                    <label class="mx-3">Location:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['attract_location']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Type:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['attract_type']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Image Name:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['attract_image']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Address:</label>
        ...
        <script type="text/javascript">
            ...
            <script type="text/javascript">
                ...
                if (isset($_GET['select'])) {
                    ...
                    } else if (isset($_GET['remove_attract_id_select'])) {
