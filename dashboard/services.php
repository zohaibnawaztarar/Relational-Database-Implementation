...
<head>
    ...
    <title>OpenAir Booking | Services</title>
        ...
        <div class="container">
            <div class="row justify-content-around mt-5">
                ...
                <div class="col-sm-8 m-auto text-center">
                    <h1><i class="fas fa-taxi"></i> Services</h1>
                    <?php
            ...
            <div class="row my-5">
                <div class="col-sm-4 buttonlist">
                    ...
                    <button id="add" class="btn crud-btn my-1" onclick="showHideCRUD(this.id)" type="back">Add Service</button>
                    <button id="update" class="btn crud-btn my-1" onclick="showHideCRUD(this.id)" type="back">Update Service Info</button>
                    <button id="remove" class="btn crud-btn my-1" onclick="showHideCRUD(this.id)" type="back">Remove Service</button>
                    <?php } ?>
                </div>
                <div class="col-sm-8">
                    <div id="view_all_div">
                    ...
                    <div id="add_div">
                        <form action="" method="GET">
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Flights:</label>
                                    <input class="form-control" type="text" placeholder="e.g. FlightsLTD" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Holidays:</label>
                                    <input class="form-control" type="text" placeholder="e.g. HolidaysLTD" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Destinations:</label>
                                    <input class="form-control" type="text" placeholder="e.g. Dundee, London" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Accomodation:</label>
                                    <input class="form-control" type="text" placeholder="e.g. HotelsLTD" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Cost (£):</label>
                                    <input class="form-control" type="text" placeholder="e.g. 1234.56" value="" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Service Provider ID:</label>
                    ...
                    <div id="update_div">
                    <?php
                        if (!isset($_GET['update_service_id_select'])) { ?>
                        <form action="" method="GET">
                            <div class="form-group">
                                <label for="update_service_select">Select Service to Modify:</label>
                                <select class="form-control" id="update_service_select" name="update_service_id_select">
                                    <?php
                                        ...
                                        while ($record = mysqli_fetch_assoc($resultset)) {
                                            ...
                                            $desc = $record['service_flights'] . " | " . $record['service_holidays'] . " | " . $record['service_accomodation'];
                                            ?>
                    ...
                    <?php } ?>
                        <div id="update_details">
                            <?php
                                if (isset($_GET['update_service_id_select'])) {
                                    $usr = $_GET['update_service_id_select'];
                                    $sql = "SELECT * FROM services WHERE service_id = $usr";
                                    $resultset = mysqli_query($conn, $sql) or die("database error:" . mysqli_error($conn));
                                    while ($record = mysqli_fetch_assoc($resultset)) {
                            ?>
                            <form action="" method="GET">
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Flights:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['service_flights']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Holidays:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['service_holidays']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Destinations:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['service_destinations']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Accomodation:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['service_accomodation']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Cost:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['service_cost']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Service Provider ID:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['service_provider_provider_id']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-4">
                    ...
                    <div id="remove_div">
                    <?php
                        if (!isset($_GET['remove_service_id_select'])) { ?>
                        <form action="" method="GET">
                            <div class="form-group">
                                <label for="remove_service_select">Select User to Remove:</label>
                                <select class="form-control" id="remove_service_select" name="remove_service_id_select">
                                    <?php
                                        $sql = "SELECT * FROM services";
                                        $resultset = mysqli_query($conn, $sql) or die("database error:" . mysqli_error($conn));
                                        while ($record = mysqli_fetch_assoc($resultset)) {
                    ...
                    <?php } ?>
                        <div id="remove_details">
                            <?php
                                if (isset($_GET['remove_service_id_select'])) {
                                    $usr = $_GET['remove_service_id_select'];
                                    $sql = "SELECT * FROM services WHERE service_id = $usr";
                                    $resultset = mysqli_query($conn, $sql) or die("database error:" . mysqli_error($conn));
                                    while ($record = mysqli_fetch_assoc($resultset)) {
                            ?>
                            <form action="" method="GET">
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Flights:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['service_flights']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Holidays:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['service_holidays']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Destinations:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['service_destinations']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Accomodation:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['service_accomodation']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Cost:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['service_cost']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Service Provider ID:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['service_provider_provider_id']; ?>" readonly />
                                </div>
                                <div class="form-group form-inline my-4">
        ...
        <script type="text/javascript">
            ...
            <script type="text/javascript">
                ...
                if (isset($_GET['select'])) {
                    ...
                    } else if (isset($_GET['remove_service_id_select'])) {
