...
<head>
    ...
    <title>OpenAir Booking | Staff</title>
        ...
        <div class="container">
            <div class="row justify-content-around mt-5">
                ...
                <div class="col-sm-8 m-auto text-center">
                    <h1><i class="fas fa-user-friends"></i> Staff</h1>
                    <?php
            ...
            <div class="row my-5">
                <div class="col-sm-4 buttonlist">
                    ...
                    <button id="add" class="btn crud-btn my-1" onclick="showHideCRUD(this.id)" type="back">Add Staff Member
                    </button>
                    <button id="update" class="btn crud-btn my-1" onclick="showHideCRUD(this.id)" type="back">Update Staff
                        Member
                    </button>
                    <button id="remove" class="btn crud-btn my-1" onclick="showHideCRUD(this.id)" type="back">Remove Staff
                        Member
                    </button>
                ...
                <div class="col-sm-8">
                    <div id="view_all_div" style="display: block;">
                    ...
                    <div id="add_div">
                        <form action="" method="GET">
                            <div class="form-group form-inline my-1">
                                ...
                                <input class="form-control" type="text" placeholder="e.g. Bob" value="" required />
                            </div>
                            <div class="form-group form-inline my-1">
                                <label class="mx-3">Last Name:</label>
                                <input class="form-control" type="text" placeholder="e.g. Smith" value="" required />
                            </div>
                            <div class="form-group form-inline my-1">
                                <label class="mx-3">Gender:</label>
                                <input class="form-control" type="text" placeholder="e.g. Male" value="" required />
                            </div>
                            <div class="form-group form-inline my-1">
                                <label class="mx-3">Position:</label>
                                <input class="form-control" type="text" placeholder="e.g. Staff" value="" required />
                            </div>
                            <div class="form-group form-inline my-1">
                                <label class="mx-3">Phone:</label>
                                <input class="form-control" type="text" placeholder="e.g. 01234567891" value="" required />
                            </div>
                            <div class="form-group form-inline my-1">
                                <label class="mx-3">eMail:</label>
                                <input class="form-control" type="text" placeholder="e.g. e@mail.com" value="" required />
                            </div>
                            <div class="form-group form-inline my-1">
                                <label class="mx-3">Salary (£):</label>
                                <input class="form-control" type="text" placeholder="e.g. 1200" value="" required />
                            </div>
                            <div class="form-group form-inline my-1">
                                <label class="mx-3">Start Date:</label>
                                <input class="form-control" type="date" value="" required />
                            </div>
                            <div class="form-group form-inline my-1">
                                <label class="mx-3">National Insurance:</label>
                                <input class="form-control" type="text" placeholder="e.g. AB123456C" value="" required />
                            </div>
                            <div class="form-group form-inline my-1">
                                <label class="mx-3">Branch ID:</label>
                                <input class="form-control" type="text" placeholder="e.g. 1" value="" required />
                            </div>
                            <div class="form-group form-inline my-1">
                    ...
                    <div id="update_div">
                        <?php
                        if (!isset($_GET['update_staff_id_select'])) { ?>
                        <form action="" method="GET">
                            <div class="form-group">
                                <label for="update_user_select">Select User to Modify:</label>
                                <select class="form-control" id="update_user_select" name="update_staff_id_select">
                                    <?php
                                        ...
                                        while ($record = mysqli_fetch_assoc($resultset)) {
                                            unset($id, $name);
                                            $id = $record['staff_id'];
                                            $name = $record['staff_first_name'] . " " . $record['staff_last_name'];
                                            ?>
                        ...
                        <div id="update_details">
                            <?php
                                if (isset($_GET['update_staff_id_select'])) {
                                    $usr = $_GET['update_staff_id_select'];
                                    $sql = "SELECT * FROM staff WHERE staff_id = $usr";
                                    $resultset = mysqli_query($conn, $sql) or die("database error:" . mysqli_error($conn));
                                    while ($record = mysqli_fetch_assoc($resultset)) {
                            ?>
                            <form action="" method="GET">
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">First Name:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['staff_first_name']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Last Name:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['staff_last_name']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Gender:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['staff_gender']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Position:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['staff_position']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Phone:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['staff_phone']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">eMail:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['staff_email']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Salary:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['staff_salary']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Start Date:</label>
                                    <input class="form-control" type="date" value="<?php echo $record['staff_start_date']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">National Insurance:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['staff_national_insurance']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Branch ID:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['branch_branch_id']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Address ID:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['address_address_id']; ?>" required />
                                </div>
                                <div class="form-group form-inline my-4">
                    ...
                    <div id="remove_div">
                        <?php
                        if (!isset($_GET['remove_staff_id_select'])) { ?>
                        <form action="" method="GET">
                            <div class="form-group">
                                <label for="remove_user_select">Select User to Remove:</label>
                                <select class="form-control" id="remove_user_select" name="remove_staff_id_select">
                                    <?php
                                        $sql = "SELECT * FROM staff";
                                        $resultset = mysqli_query($conn, $sql) or die("database error:" . mysqli_error($conn));
                                        while ($record = mysqli_fetch_assoc($resultset)) {
                        ...
                        <div id="remove_details">
                            <?php
                                if (isset($_GET['remove_staff_id_select'])) {
                                    $usr = $_GET['remove_staff_id_select'];
                                    $sql = "SELECT * FROM staff WHERE staff_id = $usr";
                                    $resultset = mysqli_query($conn, $sql) or die("database error:" . mysqli_error($conn));
                                    while ($record = mysqli_fetch_assoc($resultset)) {
                            ?>
                            <form action="" method="GET">
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">First Name:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['staff_first_name']; ?>" readonly/>
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Last Name:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['staff_last_name']; ?>" readonly/>
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Gender:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['staff_gender']; ?>" readonly/>
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Position:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['staff_position']; ?>" readonly/>
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Phone:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['staff_phone']; ?>" readonly/>
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">eMail:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['staff_email']; ?>" readonly/>
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Salary:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['staff_salary']; ?>" readonly/>
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Start Date:</label>
                                    <input class="form-control" type="date" value="<?php echo $record['staff_start_date']; ?>" readonly/>
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">National Insurance:</label>
                                    <input class="form-control" type="text" value="<?php echo $record['staff_national_insurance']; ?>" readonly/>
                                </div>
                                <div class="form-group form-inline my-1">
                                    <label class="mx-3">Branch ID:</label>
...
?>
        ...
        <script type="text/javascript">
            ...
            var r = document.getElementById("remove_div");
                ...
                } else if (isset($_GET['remove_staff_id_select'])) {
