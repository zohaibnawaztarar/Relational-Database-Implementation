...
<head>
    ...
    <title>OpenAir Booking | Registration</title>
                ...
                <div id="register">
                    <form action="php/register.php" method="GET">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input name="username" class="form-control" type="text" placeholder="e.g. bsmith10" value="" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Password</label>
                            <div class="col-sm-10">
                                <input name="password" class="form-control" type="password" placeholder="e.g. p455w0rd" value="" required>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input name="phone_number" class="form-control" type="text" placeholder="e.g. 01234567891" value="" required>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input name="nationality" class="form-control" type="text" placeholder="e.g. British" value="" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-10">
